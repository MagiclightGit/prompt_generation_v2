    ...
    while True:
        ...
        for req in request:
            ...
            # try:
                ...
                pos_prompts, neg_prompts, sub_pos_prompts,display_prompt,common_style_prompt,tags= op_prompt_generate.run(flow_id, project_id, chapter_id, para_id, ipbible, model_info)
